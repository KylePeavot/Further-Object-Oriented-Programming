...
public class Parser 
{
    ...
    public Command getCommand() 
    {
        ...
        if(tokenizer.hasNext()) {
            ...
            switch (word) {
                ...
                case "look" : direction = parseEnum(tokenizer, directions);
                              if (direction != null) {
                                  return (GameMain ui, Game game) -> game.lookRoom(direction);
                              }
                              break;
                case "take" : Item item = parseEnum(tokenizer, items);
                              if (item != null) {
                                  return (GameMain ui, Game game) -> game.takeItem(item);
                              }
                              break;
    ...
    {
        return "go <direction>, quit, help, look, take, eat";
    }
